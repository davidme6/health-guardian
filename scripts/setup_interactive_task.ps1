# Health Guardian - Interactive Scheduled Task
...
$taskName = "HealthGuardian-Interactive-Notify"
...
Register-ScheduledTask -TaskName $taskName -Action $action -Trigger $trigger -Settings $settings -Description "Health Guardian Interactive Notification - Ask for real data" -Force

Write-Host "OK - Interactive notification task created"
